@prefix : <${baseURI}> .
@prefix swc: <${baseURI}ns/swc/ontology#> . 
...
map:author_made_research_paper a d2rq:PropertyBridge;
	d2rq:belongsToClassMap map:Author;
	d2rq:uriPattern "${baseURI}conference/${confAcronym?lower_case}/${year}/paper/research/@@author.submission #@@";
	d2rq:condition "submission.`track #` = '2'";		
	d2rq:property foaf:made .
	
map:author_made_inuse_paper a d2rq:PropertyBridge;
	d2rq:belongsToClassMap map:Author;
	d2rq:uriPattern "${baseURI}conference/${confAcronym?lower_case}/${year}/paper/inuse/@@author.submission #@@";
...
map:committee_role a d2rq:PropertyBridge;
	d2rq:belongsToClassMap map:Committee;
	d2rq:constantValue <${baseURI}conference/${confAcronym?lower_case}/${year}/program-committee-member>;
	d2rq:property swc:holdsRole .
	
# Roles
map:PCM a d2rq:ClassMap;
	d2rq:dataStorage map:database;
	d2rq:uriPattern "${baseURI}conference/${confAcronym?lower_case}/${year}/program-committee-member";
	d2rq:join "committee.# = pcm.#";
	d2rq:alias "committee as pcm";
...
map:ReserachPaper a d2rq:ClassMap;
	d2rq:dataStorage map:database;
	d2rq:uriPattern "${baseURI}conference/${confAcronym?lower_case}/${year}/paper/research/@@submission.#@@";
	d2rq:condition "submission.`track #` = '2' AND submission.decision = 'Paper is accepted'";	
...
map:research_paper_track a d2rq:PropertyBridge;
	...
	d2rq:constantValue <${baseURI}conference/${confAcronym?lower_case}/${year}/paper/research>;
...
map:InUsePaper a d2rq:ClassMap;
	d2rq:dataStorage map:database;
	d2rq:uriPattern "${baseURI}conference/${confAcronym?lower_case}/${year}/paper/inuse/@@submission.#@@";
	d2rq:condition "submission.`track #` = '1' AND submission.decision = 'Paper is accepted'";	
	d2rq:join "submission.# = author.submission #";
	d2rq:class swrc:InProceedings .
	
map:inuse_paper_track a d2rq:PropertyBridge;
	d2rq:belongsToClassMap map:InUsePaper;
	d2rq:constantValue <${baseURI}conference/${confAcronym?lower_case}/${year}/paper/inuse>;
	d2rq:property swc:relatedToEvent .
